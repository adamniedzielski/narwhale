...
describe PackagesController do
  ...
  let(:valid_attributes) { { "category" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved package as @package" do
        ...
        post :create, {:package => { "category" => "invalid value" }}, valid_session
        assigns(:package).should be_a_new(Package)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested package" do
        ...
        Package.any_instance.should_receive(:update).with({ "category" => "1" })
        put :update, {:id => package.to_param, :package => { "category" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the package as @package" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Package.any_instance.stub(:save).and_return(false)
        put :update, {:id => package.to_param, :package => { "category" => "invalid value" }}, valid_session
        assigns(:package).should eq(package)
      end
